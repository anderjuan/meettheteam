...
function getInfo(name) {switch (name) {
  ...
  break;
  case 'Roberto':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Beauty, Foodie</span>' + '<p class="bio es">Como jefe de cocina, estaré encantado de recomendarte restaurantes y decirte qué platos no te puedes perder en Madrid.</p>';
  break;
  case 'Miguel':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Beauty, Foodie</span>' + '<p class="bio es">Conciertos, buena música en vivo o salir a bailar, I rock!</p>';
  break;
  case 'Adrian':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Beauty, Foodie</span>' + '<p class="bio es">Soy el cocinero de The Captain, así que te animo a que te pases por nuestro restaurante… pero también te recomendaré los mejores sitios del barrio y de la ciudad.</p>';
  break;
  case 'Luis':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Beauty, Foodie</span>' + '<p class="bio es">Como encargado del servicio técnico del hotel, estoy a tu disposición para cualquier cosa que necesites reparar o si necesitas información de materiales, muebles…</p>';
  break;
  case 'AngelG':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> Angel</span><br>` + '<span class="badge">Beauty, Foodie</span>' + '<p class="bio es">Siempre me verás de noche, que es cuando trabajo. Como tengo niños, puedo sugerirte planes de familia o lo que necesites.</p>';
    // For AngelG name is printed manually because there is another Angel
  break;
  case 'Belen':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Beauty, Foodie</span>' + '<p class="bio es">Fanática del Atleti y experta en la vida del barrio.</p>';
  break;
  default:
