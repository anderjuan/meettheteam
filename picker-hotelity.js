...
function getInfo(name) {switch (name) {
  case 'Sabrina':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Family, Rock music</span>' + '<p class="bio es">Nuestra Host conoce los mejores planes para disfrutar de un completo día en familia.</p>';
    break;
  case 'Patricia':
    ...
    break;
  case 'Lucía':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Mascotas, Shopping</span>' + '<p class="bio es">Si vienes acompañado de tu perro a Triball, Lucía sabrá indicarte los mejores restaurantes y tiendas donde disfrutar acompañado de tu mascota.</p>';
  break;
  case 'Daniel':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Fotografía, Foodie</span>' + '<p class="bio es">Gran aficionado a la fotografía, Daniel es un gran conocedor de las mejores rutas urbanas donde sacar el mejor partido a la luz y fotografiar los paisajes de la ciudad.</p>';
  break;
  case 'Fran':
  ...
  break;
  case 'Pablo':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Foodie, Music</span>' + '<p class="bio es">Pablo podrá recomendarte los mejores restaurantes para cualquier ocasión y los planes más healthy para todos los deportistas que vengan a visitarnos.</p>';
  break;
  case 'Lorena':
  ...
  break;
  case 'Carlos':
    document.getElementById('description').innerHTML = `<span class="name">Hello, my name is <br> ${name}</span><br>` + '<span class="badge">Futbol</span>' + '<p class="bio es">Carlos, nuestro responsable de mantenimiento, es además un gran aficionado al fútbol.</p>';
  break;
  default:
